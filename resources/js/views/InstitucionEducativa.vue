                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="12" md="6">
                      <v-autocomplete
                        dense
                        :disabled="!isEditingTipoInsEdu"
                        v-model="modelTipoInsEdu"
                        :items="itemsTipoInsEdu"
                        :loading="isLoadingTipoInsEdu"
                        clearable
                        hide-details
                        hide-selected
                        item-text="descripcion"
                    ...
                    <v-col cols="12" sm="6" md="6">
                      <v-autocomplete
                        dense
                        :disabled="!isEditingDeno"
                        v-model="modelDeno"
                        :items="itemsDeno"
                        :loading="isLoadingDeno"
                        clearable
                        hide-details
                        hide-selected
                        item-text="denominacion"
                        item-value="iddenominacion"
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Codigo", value: "codigo", align: " d-none" },
        { text: "Cod. Ubi", value: "codubi", align: " d-none" },
        { text: "idZona", value: "idzona", align: " d-none" },
        { text: "Zona", value: "nomzona", align: " d-none" },
        { text: "Referencia", value: "refdir" },
        { text: "Vía", value: "iddeno", align: " d-none" },
        { text: "Estado", value: "estado", align: " d-none" },
