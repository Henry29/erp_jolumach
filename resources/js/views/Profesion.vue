<template>
    <v-card  color="green accent-3">
        <v-toolbar class="mb-2" color="indigo accent-3" dark flat>
            <v-toolbar-title>Gestión Profesión</v-toolbar-title>
        </v-toolbar>
        <v-skeleton-loader v-if="firstLoad" :loading="loading" type="table">
           
            <v-data-table dense :headers="headers" :items="desserts" :search="search" sort-by="idmaestro"
                class="elevation-1">
                <template v-slot:top>
                    <v-toolbar flat>
                        <!-- <v-toolbar-title>Listado Profesión</v-toolbar-title> -->
                        ...
                        <v-dialog v-model="dialog" max-width="450px">
                            <template v-slot:activator="{ on, attrs }">
                                <v-btn dark color="indigo accent-3" class="mb-2" v-bind="attrs" v-on="on">
                                    Nuevo
                                </v-btn>
                            </template>
                            <v-card>
                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12" sm="6" md="6">
                                                <v-text-field v-model="editedItem.abrev" label="Abreviatura">
                                                </v-text-field>
                                            </v-col>
                                            ...
                                            <v-col cols="12" sm="6" md="4">
                                                <v-switch v-model="editedItem.estado" label="Estado"
                                                    color="indigo darken-2" hide-details></v-switch>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
