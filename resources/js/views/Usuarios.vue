                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field
                        v-model="editedItem.roles_nombre"
                        label="Nombre"
                      ></v-text-field>
                      <v-text-field
                        v-model="editedItem.roles_descripcion"
                        label="Correo"
                      ></v-text-field>
                       <v-text-field
  ...
  data() {
    return {
      ...
      headers: [     
        ...
        { text: "Usuarios", value: "usuarios_nombre" },
        { text: "Contraseña de acceso", value: "usuarios_contraseña" },             
        { text: "Nombre de rol", value: "roles_nombre" },
        { text: "Descripcion", value: "roles_descripcion" }, 
         { text: "estado usuarios", value: "usuarios_estado" },      
