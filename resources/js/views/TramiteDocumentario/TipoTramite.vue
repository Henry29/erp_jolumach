...
export default {
  ...
  methods: {       
    ...
    deleteItemConfirm() {
      ...
      axios
        .delete("/Tramite_TipoTramite/borrar/" + id)
        .then(function (response) {
          console.log(response);
          if (response.data === 1) {
            me.text = "Se eliminó el tipo de Trámite Cod: " + id;
          } else {
            me.text = "No se eliminó el tipo de Trámite";
          }
    ...
    save() {
      let me = this;
      let url = "/Tramite_TipoTramite/guardar"; //Ruta que hemos creado para enviar una tarea y guardarla
        ...
        .then(function (response) {
          if (response.data[0].estado_registro === true) {
            me.text =
              "Se " +
              textSave +
              " el tipo de Trámite con Cod: " +
              response.data[0].identificador_ane;
          } else {
            me.text = "No se " + textSave + " el tipo de Trámite";
          }
          me.dialog = false;
          me.snackbar = true;
          me.initialize();
